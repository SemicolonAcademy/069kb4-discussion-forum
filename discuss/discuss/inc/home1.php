 <div class="interests">
<span class="breadcum"> <a href="index.php?page=home&id=<?php echo $uid; ?>">Discuss Home</a> &raquo; <?php echo $category=$_GET['cat']; ?>  
    ...
    <div class="discus_topics">
		  ...
		  $qry_select=mysql_query("select * from tbl_topics where category='$category'",$con);
           ...
           $qry_select2=mysql_query("select * from tbl_discuss",$con);
		  ?>
